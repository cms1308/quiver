...
well-defined leading-$N$ $a$-maximum.  Class~877 is omitted because
its leading-$N$ $a$-maximisation does not return an interior critical
point (Section~\ref{sec:class-special}); the boundary coefficients
$\alpha_{b}^{(a\star)}$ are not defined there.  The
