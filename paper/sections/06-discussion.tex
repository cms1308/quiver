...
compute IR R-charges and central charges.  Seven universality classes
emerge, all satisfying $a=c$ to leading order in $1/N$.
...
boundaries; class 1 has an $a$-maximum on the boundary of the
unitarity polytope and is non-interacting at leading $N$.
...
uniform appearance of $a=c$ across all seven classes suggests the
non-Veneziano restriction is itself the relevant filter: the
...
free-field value $2/3$, which holds in all seven classes.  A
...
\begin{itemize}
  ...
  \item \textbf{Sub-leading treatment of class 44 and class 1.}
    Class 44's boundary coefficients vanish at leading $N$; the
    subleading structure would determine its RG topology exactly.
    Class 1's leading-$N$ $a$-max is non-unitary; lifting the
    R-charges into the interior of the polytope by sub-leading
    corrections (or finding a different R-symmetry extremum) would
    give its physical IR.
