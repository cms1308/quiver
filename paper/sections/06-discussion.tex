...
class 877 is a degenerate case in which one node carries no intrinsic
matter, so the full-theory $a$-maximisation has no interior critical
point.
...
\begin{itemize}
  ...
  \item \textbf{Sub-leading treatment of classes 1, 9, 44, and 877.}
    ...
    matter and a degenerate leading-$N$ $a$-maximisation; the flat
    direction is presumably lifted by sub-leading effects whose
    analysis requires a different framework.
